...
public class GroupMetricsService {
    ...
    /** Student-facing: the authenticated student's own summary over the group's published assignments. */
    @Transactional(readOnly = true)
    ...
    /** Student-facing: the authenticated student's own row per published assignment of the group. */
    @Transactional(readOnly = true)
