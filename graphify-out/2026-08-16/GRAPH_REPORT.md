...
## Corpus Check
- 537 files · ~180,874 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4622 nodes · 11422 edges · 288 communities (204 shown, 84 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1276 edges (avg confidence: 0.8)
...
## Communities (288 total, 84 thin omitted)
...
Cohesion: 0.09
Nodes (6): AssignmentGrade, Entity, Table, Service, Transactional, StudentWorkQueryService
...
Cohesion: 0.11
Nodes (25): STUDENT_NAV, STUDENT_SIDEBAR_ITEMS, STUDENT_STATS_ICONS, deleteAssignment(), getActiveTeacherGroups(), getTeacherAssignments(), listTeacherGroups(), getGroupMetricsOverview() (+17 more)
...
Cohesion: 0.06
Nodes (10): JsonInclude, ComparatorType, EXACT_MATCH, FLOATING_POINT, Language, C, CPP, JAVA (+2 more)
...
Cohesion: 0.12
Nodes (14): EmailTemplateRenderer, Component, TemplateEngine, RenderedEmail, NotificationEmailContent, CompetingTemplateEngineConfig, EmailTemplateConfigTest, Bean (+6 more)
...
Cohesion: 0.06
Nodes (38): ApplicationEvents, Component, Logger, TestGenerationResultListener, ExecutionRequestProducer, Logger, RabbitTemplate, Service (+30 more)
...
Cohesion: 0.22
Nodes (5): StudentGradeRow, GroupMetricsService, GroupSnapshot, Service, Transactional
...
Cohesion: 0.11
Nodes (11): AccessDeniedException, CloneAssignmentFormDTO, CloneAssignmentTestCaseDTO, EntityNotFoundException, ValidationException, AssignmentLimits, AssignmentService, Logger (+3 more)
...
Cohesion: 0.15
Nodes (13): Component, Logger, RabbitListener, Transactional, NotificationEmailListener, NotificationStrategy, Component, NotificationStrategyRegistry (+5 more)
...
Cohesion: 0.05
Nodes (4): Assignment, Page, Query, Pageable

### Community 30 - "Execution Entity"
Cohesion: 0.09
Nodes (8): Execution, ExecutionDTO, Scheduled, Transactional, Transactional, ArtifactCleanupServiceTest, BeforeEach, Test
...
Cohesion: 0.12
Nodes (16): Logger, RabbitTemplate, Service, TestGenerationRequestProducer, MinioClient, Service, ObjectStorageService, ActiveProfiles (+8 more)
...
Cohesion: 0.05
Nodes (22): getInitialTheme(), Theme, ThemeContext, ThemeContextType, ThemeProvider(), useTheme(), AdminLayout(), AdminLayoutProps (+14 more)

### Community 49 - "AssignmentGrade"
Cohesion: 0.12
Nodes (25): forRole(), getAudience(), ApplicationEventPublisher, Component, NotificationDomainEventPublisher, AssignmentGradeHistoryRepository, AssignmentGradeRepository, AssignmentRepository (+17 more)
...
Cohesion: 0.13
Nodes (24): createAssignment(), getAssignmentUpdate(), getTeacherAssignment(), getTeacherAssignmentPage(), multipartMetadata(), multipartRequest(), normalizeAssignment(), updateAssignment() (+16 more)
...
Cohesion: 0.07
Nodes (17): AssignmentFeedbackDTO, AssignmentFeedback, Entity, Table, FeedbackStatus, DELETED, PUBLISHED, AssignmentFeedbackRepository (+9 more)

### Community 58 - "UserDTO"
Cohesion: 0.08
Nodes (14): JsonInclude, UserDTO, IncorrectCredentialsException, UserMapper, AuthResponse, AuthService, AuthResponse, MultipartFile (+6 more)

### Community 59 - "AssignmentGradeHistory"
Cohesion: 0.06
Nodes (33): AssignmentStudentWorkController, ApiResponse, Authentication, DeleteMapping, GetMapping, Operation, PostMapping, PreAuthorize (+25 more)
...
### Community 62 - "Scope"
Cohesion: 0.06
Nodes (22): Scope, CHECK_ANALYTICS, CREATE_ADMINS, CREATE_GROUP, CREATE_USERS, MANAGE_ADMIN_STATUS, MANAGE_GROUPS, MANAGE_SCOPES (+14 more)
...
Cohesion: 0.16
Nodes (18): ApiResponse, Authentication, GetMapping, Operation, PostMapping, PutMapping, RequestMapping, ResponseEntity (+10 more)

### Community 70 - ".buildExecutionJob"
Cohesion: 0.09
Nodes (8): TestCaseInfo, ExecutionJob, ExecutionTestCaseInfo, ExecutionJob, ExecutionTestCaseInfo, ObjectKeyBuilder, Test, ObjectKeyBuilderTest
...
Cohesion: 0.08
Nodes (5): ExecutionType, DEFINITIVE, PRACTICE, ExecutionRequest, Query

### Community 76 - "useAuth"
Cohesion: 0.09
Nodes (21): AuthContext, AuthProvider(), useAuth(), removeAuthToken(), setAuthToken(), AdminDashboardPage(), NAV_CARDS, STATS (+13 more)
...
Cohesion: 0.28
Nodes (19): teacherRequest(), archiveGroup(), createGroup(), deleteGroup(), getTeacherGroup(), groupPath(), listGroupStudents(), removeGroupStudent() (+11 more)
...
Cohesion: 0.19
Nodes (18): getAssignmentMetrics(), listAssignmentMetrics(), listStudentMetrics(), percentage(), TeacherAnalyticsPage(), AssignmentValidationStatus, Language, AssignmentMetrics (+10 more)
...
Cohesion: 0.16
Nodes (6): AssignmentUpdateDTO, AssignmentUpdateService, AssignmentUpdate, MultipartFile, Service, Transactional
...
Cohesion: 0.29
Nodes (6): AssignmentServiceTest, Assignment, BeforeEach, ClassGroup, Test, User
...
Cohesion: 0.16
Nodes (11): AuthServiceTest, BeforeEach, DisplayName, ExtendWith, LoginRequest, Nested, PasswordEncoder, SignUpRequest (+3 more)
...
Cohesion: 0.06
Nodes (9): Entity, Table, Entity, Table, Submission, SubmissionRepository, Service, Transactional (+1 more)
...
Cohesion: 0.10
Nodes (12): Component, Logger, RabbitTemplate, NotificationProducer, NotificationMessage, Entity, Table, NotificationDispatchLog (+4 more)

### Community 128 - "teacherRequest"
Cohesion: 0.28
Nodes (13): jsonRequest(), assignmentPath(), createFeedback(), deleteFeedback(), getStudentWork(), listFeedback(), listStudentWork(), returnGrade() (+5 more)
...
### Community 133 - "SampleTestCaseDTO"
Cohesion: 0.33
Nodes (7): cloneAssignment(), getCloneAssignmentForm(), CloneAssignmentPage(), csv(), fieldClass(), LANGUAGES, localDateTimeMinimum()
...
Cohesion: 0.40
Nodes (3): CsvBulkRegistrationTests, Test, MockMultipartFile
...
Cohesion: 0.15
Nodes (11): EnrollmentStatusCount, Query, Assignment, BeforeEach, ClassGroup, DataJpaTest, EntityManager, StudentAssignmentWork (+3 more)
...
### Community 163 - "GroupMetricsController.java"
Cohesion: 0.34
...
### Community 165 - "StudentWorkStatus"
Cohesion: 0.18
Nodes (7): CurrentSubmissionRow, StudentWorkStatus, NOT_SUBMITTED, RETURNED, SUBMITTED, WITHDRAWN, Query

### Community 167 - ".assignmentDetail"
Cohesion: 0.29
Nodes (6): AcceptedPerformance, AssignmentMetricsDetailDTO, GradeSummary, StudentBreakdown, StudentRef, SubmissionResultRow

### Community 168 - "MailSenderServiceTest"
Cohesion: 0.31
Nodes (6): BeforeEach, JavaMailSender, Test, MailSenderServiceTest, MimeMessage, Part
...
### Community 176 - "AssignmentValidationStatus"
Cohesion: 0.22
...
### Community 200 - "ExecutionTrigger"
Cohesion: 0.20
Nodes (7): Entity, Table, ExecutionTrigger, ASSIGNMENT_UPDATE, INITIAL_SUBMISSION, MANUAL_RETRY, PRACTICE

### Community 201 - "RevisionStatus"
Cohesion: 0.22
Nodes (5): RevisionStatus, ACTIVE, FAILED, PROCESSING, SUPERSEDED

### Community 202 - ".fixture"
Cohesion: 0.40
Nodes (5): Fixture, StudentAssignmentWork, Submission, Test, SubmissionLifecycleServiceTest

### Community 209 - "SubmissionAttemptCount"
Cohesion: 0.31
Nodes (3): SubmissionAttemptCount, Query, Modifying

### Community 246 - "TestAsyncConfig.java"
Cohesion: 0.47
Nodes (4): AsyncConfigurer, Override, TestConfiguration, TestAsyncConfig

### Community 247 - ".overview"
Cohesion: 0.53
...
- **Why does `User` connect `User Entity` to `Assignment Feedback & Student Work`, `User Notification Settings`, `User DTO`, `CSV Bulk Register Response`, `Notification Preferences`, `Group Metrics Overview`, `Assignment Controller Integration Tests`, `Assignment Service & Clone DTOs`, `MetricsProjectionRepositoryTest`, `Notification Email Listener`, `Assignment Update Entity`, `Assignment Entity`, `Execution Entity`, `Create Assignment Request`, `Group Service`, `Notification Format Service`, `.assignmentDetail`, `Group Controller Integration Tests`, `Execution Request Service`, `AssignmentGrade`, `PasswordResetToken`, `ClassGroup`, `AssignmentFeedback`, `UserDTO`, `AssignmentGradeHistory`, `Scope`, `RecoveryPasswordRequest`, `GroupMetricsControllerIntegrationTest.java`, `GroupDTO`, `.create`, `DisplayName`, `GroupServiceTest`, `GlobalExceptionHandler.java`, `MetricsProjectionRepositoryTest`, `GroupMetricsController.java`, `CreateAssignmentPage.tsx`, `DisplayName`, `AdminUserControllerIntegrationTest`, `TestCaseResult`, `SubmissionController.java`, `AssignmentRepository`, `RecoveryPasswordControllerIntegrationTest.java`, `NotificationDomainEventRouter`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `LoginPage()` connect `useAuth` to `useTheme`, `UserDTO`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `AssignmentGrade` to `Assignment Feedback & Student Work`, `User Notification Settings`, `Notification Preferences`, `Group Metrics Overview`, `Assignment Controller Integration Tests`, `Assignment Service & Clone DTOs`, `MetricsProjectionRepositoryTest`, `Notification Email Listener`, `Group Service`, `Notification Format Service`, `User Entity`, `Group Controller Integration Tests`, `Execution Request Service`, `Auth Response`, `Scope.java`, `PasswordResetToken`, `JwtUtil`, `AssignmentFeedback`, `UserDTO`, `Scope`, `GroupMetricsControllerIntegrationTest.java`, `NotificationPreferenceController.java`, `.fixture`, `GlobalExceptionHandler.java`, `MetricsProjectionRepositoryTest`, `GroupMetricsController.java`, `CreateAssignmentPage.tsx`, `AdminUserControllerIntegrationTest`, `TestCaseResult`, `SubmissionController.java`, `AssignmentRepository`, `RecoveryPasswordControllerIntegrationTest.java`?**
