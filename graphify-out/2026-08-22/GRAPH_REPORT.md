# Graph Report - CodeHive  (2026-08-22)

## Corpus Check
- 732 files · ~236,744 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5935 nodes · 15138 edges · 377 communities (279 shown, 98 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1615 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `261d166f`
...
- Admin routes
- student/types/assignment.types.ts
- lucide-react
...
- AdminInitializer.java
- @radix-ui/react-tabs
- RateLimitIncidentServiceTest.java
- ResizeObserverMock
- RateLimitWebConfig
- WebSocketConfig
- react
...
- GroupRelationship
- Q: I recommend to move the manage groups option in the header, as the student dashboard button is there
- recharts

## God Nodes (most connected - your core abstractions)
1. `User` - 272 edges
2. `Assignment` - 205 edges
3. `UserRepository` - 144 edges
4. `AssignmentRepository` - 104 edges
5. `SuccessResponse` - 93 edges
6. `EntityNotFoundException` - 90 edges
7. `Execution` - 86 edges
8. `Language` - 81 edges
9. `Submission` - 79 edges
10. `ExecutionRepository` - 79 edges
...
## Communities (377 total, 98 thin omitted)

### Community 0 - "Assignment Update Requests"
Cohesion: 0.09
Nodes (7): fromValue(), TestSuiteUpdateMode, APPEND, REPLACE_ALL, UpdateAssignmentRequest, AssignmentUpdate, JsonCreator
...
Cohesion: 0.08
Nodes (22): AdminAuditEventDTO, AdminAuditEvent, Entity, Table, AdminAuditAction, CSV_REGISTRATION_COMPLETED, CSV_REGISTRATION_SUBMITTED, USER_BLOCKED (+14 more)
...
Cohesion: 0.10
Nodes (7): EnrollmentStatusCount, GroupEnrollmentRepository, Page, Pageable, Query, Test, UserAuthoritiesTest
...
Cohesion: 0.11
Nodes (24): AsyncConfigurer, Override, TestConfiguration, TestAsyncConfig, AssignmentControllerIntegrationTest, CreateAssignment, GetAssignmentById, ActiveProfiles (+16 more)
...
Cohesion: 0.06
Nodes (10): AssignmentPreviewDTO, AssignmentPreviewTestCaseDTO, RecentSubmissionDTO, StudentSubmissionHistoryDTO, Language, C, CPP, JAVA (+2 more)
...
Cohesion: 0.03
Nodes (20): AdminGroupResourceDTO, ClassGroup, Entity, Table, GroupEnrollment, Entity, Table, EnrollmentStatus (+12 more)
...
Cohesion: 0.09
Nodes (25): getAssignment(), ApiError, listAssignmentSubmissions(), ExecutionReportPage(), reportedMemory(), TERMINAL, testDiagnostic(), TestResultRow() (+17 more)
...
Cohesion: 0.14
Nodes (12): Component, Logger, LanguageExecutorFactory, LanguageExecutor, BeforeEach, DisplayName, Test, LanguageExecutorFactoryTest (+4 more)

### Community 21 - "Assignment Controller Integration Tests"
Cohesion: 0.13
Nodes (11): Override, ContainerSession, ExecutionReport, Logger, ObjectMapper, Service, TestCaseResult, TestExecutionService (+3 more)

### Community 22 - "Assignment Service & Clone DTOs"
Cohesion: 0.11
Nodes (11): JsonInclude, AcceptedPerformance, AssignmentMetricsDetailDTO, GradeSummary, StudentBreakdown, StudentRef, AssignmentMetricsDTO, AssignmentValidationStatus (+3 more)
...
Cohesion: 0.12
Nodes (27): listAdminUsers(), AdminShell(), AdminEmpty(), AdminError(), AdminLoading(), AdminPageHeader(), Pagination(), StatusPill() (+19 more)

### Community 26 - "Notification Dispatch Log"
Cohesion: 0.08
Nodes (24): ApplicationEventPublisher, Component, NotificationDomainEventPublisher, AssignmentFeedbackRepository, AssignmentGradeRepository, ExecutionRepository, Page, Pageable (+16 more)
...
Cohesion: 0.05
Nodes (19): Entity, Table, ReferenceSolutionRevision, RevisionStatus, ACTIVE, FAILED, PROCESSING, SUPERSEDED (+11 more)

### Community 29 - "Assignment Entity"
Cohesion: 0.04
Nodes (6): Assignment, Entity, Table, Page, Pageable, Page

### Community 30 - "Execution Entity"
Cohesion: 0.08
Nodes (12): AdminExecutionResourceDTO, Execution, Entity, Table, ExecutionTrigger, ASSIGNMENT_UPDATE, INITIAL_SUBMISSION, MANUAL_RETRY (+4 more)

### Community 31 - "Create Assignment Request"
Cohesion: 0.09
Nodes (3): CreateAssignmentRequest, MultipartFile, TestCaseInfo
...
Cohesion: 0.12
Nodes (9): AccessDeniedException, EntityNotFoundException, UpdateGroupRequest, Transactional, GroupService, SecureRandom, Service, Transactional (+1 more)
...
Cohesion: 0.13
Nodes (20): AssignmentOverview(), AnalyticsGroupContext(), AnalyticsHealth, AnalyticsOverview(), clamp(), formatDateTime(), formatPercentage(), KpiCard() (+12 more)

### Community 38 - "Group Controller"
Cohesion: 0.11
Nodes (5): AdminUserDetailDTO, ResourceCounts, ValidationException, AdminUserService, Transactional
...
Cohesion: 0.11
Nodes (24): listAssignments(), listAssignmentsForGroups(), getGroup(), joinGroup(), leaveGroup(), listMyGroups(), listGroupSubmissions(), GroupCardProps (+16 more)
...
Cohesion: 0.13
Nodes (14): STUDENT_NAV, STUDENT_SIDEBAR_ITEMS, STUDENT_STATS_ICONS, TeacherNavigation, TeacherShell(), TEACHER_CREATE_NAV, TEACHER_CREATE_SIDEBAR_ITEMS, TEACHER_NAV (+6 more)

### Community 43 - "Submission Entity"
Cohesion: 0.07
Nodes (19): JsonInclude, UserDTO, AlreadyRegisteredEmailException, AlreadyRegisteredEnrollmentNumberException, IncorrectCredentialsException, UserMapper, AuthResponse, AuthService (+11 more)

### Community 44 - "Auth Response"
Cohesion: 0.06
Nodes (45): listAssignmentMetrics(), assignmentPath(), createFeedback(), deleteFeedback(), getStudentWork(), getStudentWorkReview(), getSubmissionEvidence(), getSubmissionReport() (+37 more)
...
Cohesion: 0.11
Nodes (16): getTeacherDashboard(), DashboardSummary(), formatDateTime(), GradingQueue(), initials(), nearestEvent(), RecentSubmissionActivity(), relativeDate() (+8 more)

### Community 47 - "TestSuiteRevision"
Cohesion: 0.04
Nodes (28): AssignmentFeedback, Entity, Table, Entity, Table, StudentAssignmentWork, FeedbackStatus, DELETED (+20 more)
...
Cohesion: 0.07
Nodes (9): TestCase, MultipartFile, TestCaseInfo, ExecutionTestCaseInfo, ExecutionTestCaseInfo, FileExtensionUtil, ObjectKeyBuilder, Test (+1 more)
...
Cohesion: 0.13
Nodes (18): listRecentSubmissions(), withdrawSubmission(), AssignmentRow(), FilterTab, formatDue(), formatRelativeTime(), getGreeting(), getSemesterBadge() (+10 more)

### Community 53 - ".error"
Cohesion: 0.06
Nodes (17): SubmissionAttemptCount, Entity, Table, Submission, AssignmentGradeHistoryRepository, Modifying, Page, Pageable (+9 more)
...
Cohesion: 0.09
Nodes (9): AdminSubmissionResourceDTO, JsonInclude, SubmissionDTO, SubmissionStatus, SUBMITTED, SUPERSEDED, WITHDRAWN, Submission (+1 more)

### Community 56 - "AssignmentController.java"
Cohesion: 0.05
Nodes (33): NotificationPreferenceDTO, Entity, Table, UserNotificationPreference, NotificationAudience, OWNER, STUDENT, forUser() (+25 more)

### Community 57 - "AssignmentFeedback"
Cohesion: 0.10
Nodes (11): Component, NotificationFormatService, AssignmentNotificationStrategy, Component, Override, Override, Component, Override (+3 more)

### Community 58 - "UserDTO"
Cohesion: 0.11
Nodes (9): LoginRequest, CsvBulkRegisterResponse, JsonInclude, AuthServiceTest, BeforeEach, ExtendWith, LoginRequest, PasswordEncoder (+1 more)

### Community 59 - "AssignmentGradeHistory"
Cohesion: 0.15
Nodes (22): AssignmentStudentWorkController, Authentication, DeleteMapping, GetMapping, Operation, PostMapping, PreAuthorize, PutMapping (+14 more)
...
Cohesion: 0.06
Nodes (42): Component, Logger, TestGenerationResultListener, Logger, RabbitTemplate, Service, TestGenerationRequestProducer, AssignmentLimits (+34 more)

### Community 63 - "RecoveryPasswordRequest"
Cohesion: 0.19
Nodes (8): CsvBulkRegistrationTests, DisplayName, Nested, Test, User, LoginTests, RegistrationTests, MockMultipartFile
...
Cohesion: 0.23
Nodes (18): AssignmentController, ApiResponses, Authentication, DeleteMapping, GetMapping, Logger, MultipartFile, Operation (+10 more)

### Community 70 - ".buildExecutionJob"
Cohesion: 0.22
Nodes (7): Override, AssignmentServiceTest, Assignment, BeforeEach, ClassGroup, Test, User
...
Cohesion: 0.09
Nodes (26): getAssignmentManagementStatus(), listTeacherGroups(), AssignmentContextBar(), assignmentGroupLifecycle(), AssignmentLifecycle, AssignmentList(), AssignmentRow(), assignmentSchedule() (+18 more)
...
Cohesion: 0.04
Nodes (44): cloneAssignment(), createAssignment(), deleteAssignment(), getActiveTeacherGroups(), getAssignmentUpdate(), getCloneAssignmentForm(), getTeacherAssignment(), getTeacherAssignmentPreview() (+36 more)

### Community 77 - "CheckExecutionControllerIntegrationTest.java"
Cohesion: 0.09
Nodes (12): byteSize(), CreateAssignmentPage(), EXT_TO_LANG, LANGUAGE_TEMPLATES, LANGUAGES, lineCount(), PublishMode, SolutionMode (+4 more)
...
Cohesion: 0.17
Nodes (16): AdminUserController, Authentication, Direction, GetMapping, GroupRelationship, Operation, PageResponse, PatchMapping (+8 more)
...
Cohesion: 0.05
Nodes (43): AuthContext, AuthProvider(), useAuth(), getInitialTheme(), Theme, ThemeContext, ThemeContextType, ThemeProvider() (+35 more)
...
Cohesion: 0.19
Nodes (8): Bucket, BucketEntry, Decision, Scheduled, Service, RateLimitService, Test, RateLimitServiceTest
...
Cohesion: 0.10
Nodes (39): AuditParams, getAdminStatistics(), IncidentParams, listAdminAuditEvents(), listAdminUserAssignments(), listAdminUserExecutions(), listAdminUserGroups(), listAdminUserSubmissions() (+31 more)
...
### Community 103 - "clsx"
Cohesion: 0.11
Nodes (36): getTeacherAssignmentPage(), getTeacherAssignments(), jsonRequest(), teacherAuthHeaders(), teacherRequest(), archiveGroup(), createGroup(), deleteGroup() (+28 more)
...
Cohesion: 0.08
Nodes (8): RabbitListener, Transactional, Entity, Table, TestSuiteRevision, Transactional, Test, TestGenerationResultListenerTest

### Community 107 - "MockMultipartFile"
Cohesion: 0.06
Nodes (39): getAssignmentMetrics(), listStudentMetrics(), AssignmentAnalyticsDrawer(), AssignmentStudents(), DrawerTab, LANGUAGE_COLOR, workTone(), AnalyticsTab (+31 more)

### Community 108 - "CsvProgressWebSocketHandler"
Cohesion: 0.19
Nodes (11): CloseStatus, CsvProgressWebSocketHandler, Component, Logger, ObjectMapper, Override, PendingTask, PreDestroy (+3 more)
...
Cohesion: 0.21
Nodes (9): CsvRegistrationService, Async, Autowired, Logger, PasswordEncoder, Pattern, Service, CSVRecord (+1 more)
...
Cohesion: 0.15
Nodes (9): AssignmentGradeService, Service, Transactional, AssignmentGradeServiceTest, Assignment, AssignmentGrade, BeforeEach, Test (+1 more)
...
Cohesion: 0.07
Nodes (18): AssignmentPage(), formatMemory(), LANGUAGE_FILE, LANGUAGE_LABELS, LANGUAGE_TEMPLATES, LANGUAGE_VERSIONS, MONACO_LANG_MAP, practiceInputs() (+10 more)
...
Cohesion: 0.27
Nodes (6): RateLimitIncidentDTO, Page, Scheduled, Service, Transactional, RateLimitIncidentService
...
Cohesion: 0.11
Nodes (13): CurrentSubmissionRow, AssignmentBreakdown, EnrollmentBreakdown, GradingProgress, GroupMetricsOverviewDTO, StudentGradeRow, SubmissionResultRow, Query (+5 more)
...
Cohesion: 0.15
Nodes (6): AssignmentService, Logger, Service, Transactional, ExecutionJob, ExecutionJob

### Community 151 - "StudentWorkQueryService"
Cohesion: 0.15
Nodes (12): AssignmentFeedbackDTO, AssignmentFeedbackService, AssignmentFeedback, Service, Transactional, AssignmentFeedbackServiceTest, Assignment, AssignmentFeedback (+4 more)
...
Cohesion: 0.10
Nodes (13): Role, ADMIN, STUDENT, TEACHER, UpdateUserRoleRequest, Scope, EnrollmentNumberRules, Pattern (+5 more)

### Community 156 - "@monaco-editor/react"
Cohesion: 0.15
Nodes (8): StudentAssignmentWork, Transactional, Transactional, Assignment, Test, User, StudentAssignmentWorkServiceTest, Test
...
### Community 164 - ".setUp"
Cohesion: 0.25
Nodes (6): Scheduled, Service, Ticket, WebSocketTicketService, Test, WebSocketTicketServiceTest

### Community 168 - "AssignmentValidationStatus"
Cohesion: 0.10
Nodes (19): ExecutionResultListener, Component, Logger, RabbitListener, ExecutionRequestProducer, Logger, RabbitTemplate, Service (+11 more)
...
### Community 175 - "AdminUserStatus"
Cohesion: 0.17
Nodes (9): AdminUserSummaryDTO, AdminUserStatus, ACTIVE, BLOCKED, DELETED, UpdateUserStatusRequest, Direction, Page (+1 more)
...
### Community 210 - "@radix-ui/react-separator"
Cohesion: 0.25
Nodes (14): getAdminUser(), AdminUserDialogs(), dialogConfig(), UserAction, AdminUserDetailPage(), TABS, AdminUserSummary, availableRoleChanges() (+6 more)

### Community 214 - "@react-router/node"
Cohesion: 0.33
Nodes (11): Authentication, GetMapping, Operation, PostMapping, PreAuthorize, RequestMapping, ResponseEntity, RestController (+3 more)
...
### Community 244 - "student/types/assignment.types.ts"
Cohesion: 0.13
Nodes (20): listMyAssignmentFeedback(), listMyAssignmentOverviews(), GradeFilter, GradesPage(), AssignmentCard(), FilterTab, formatDate(), LANG_ABBR (+12 more)
...
### Community 248 - "SignUpRequest"
Cohesion: 0.31
Nodes (10): AdminMonitoringController, GetMapping, Operation, PageResponse, PreAuthorize, RequestMapping, ResponseEntity, RestController (+2 more)

### Community 249 - "ComparatorType"
Cohesion: 0.16
Nodes (19): ErrorResponse, jsonBody(), studentAuthHeaders(), studentRequest(), SuccessResponse, getExecution(), getExecutionReport(), submitExecution() (+11 more)
...
### Community 342 - "ComparatorType"
Cohesion: 0.11
Nodes (5): CloneAssignmentFormDTO, CloneAssignmentTestCaseDTO, ComparatorType, EXACT_MATCH, FLOATING_POINT
...
### Community 346 - "GroupServiceTest"
Cohesion: 0.17
Nodes (5): GroupServiceTest, BeforeEach, ClassGroup, Test, User

### Community 347 - "CheckExecutionControllerIntegrationTest.java"
Cohesion: 0.19
Nodes (14): ApplicationEvents, Entity, Table, ExecutionJobCreatedEvent, CheckExecutionControllerIntegrationTest, ActiveProfiles, AutoConfigureMockMvc, Import (+6 more)

### Community 348 - ".processExecutionResult"
Cohesion: 0.26
Nodes (5): Transactional, ExecutionResultServiceTest, ExecutionReport, ExtendWith, Test

### Community 349 - "NotificationReminderScheduler"
Cohesion: 0.23
Nodes (5): Component, Logger, Scheduled, Transactional, NotificationReminderScheduler

### Community 350 - "RateLimitInterceptorTest.java"
Cohesion: 0.29
Nodes (6): AfterEach, Fixture, ExtendWith, Test, RateLimitInterceptorTest, HandlerMethod

### Community 351 - "WebSocketTicketHandshakeInterceptor"
Cohesion: 0.35
Nodes (7): Component, Override, WebSocketTicketHandshakeInterceptor, HandshakeInterceptor, ServerHttpRequest, ServerHttpResponse, WebSocketHandler

### Community 352 - ".fixture"
Cohesion: 0.24
...
### Community 353 - "Language"
Cohesion: 0.17
Nodes (5): Language, C, CPP, JAVA, PYTHON

### Community 355 - "Backend Admin API"
Cohesion: 0.29
Nodes (6): Account lifecycle, Backend Admin API, CSV progress WebSocket, Monitoring endpoints, Rate limiting, User endpoints

### Community 357 - "StudentWorkQueryService"
Cohesion: 0.41
...
### Community 361 - "AdminInitializer.java"
Cohesion: 0.06
Nodes (30): AdminInitializer, Component, Logger, PasswordEncoder, AdminStatisticsDTO, ResourceStatistics, UserStatistics, GroupNotificationStrategy (+22 more)

### Community 363 - "RateLimitIncidentServiceTest.java"
Cohesion: 0.31
Nodes (5): RateLimitIncident, BeforeEach, ExtendWith, Test, RateLimitIncidentServiceTest

### Community 364 - "ResizeObserverMock"
Cohesion: 0.29
Nodes (3): localStorageMock, ResizeObserverMock, storage

### Community 365 - "RateLimitWebConfig"
Cohesion: 0.33
Nodes (6): Configuration, Override, Profile, RateLimitWebConfig, InterceptorRegistry, WebMvcConfigurer

### Community 366 - "WebSocketConfig"
Cohesion: 0.33
Nodes (6): Configuration, Override, WebSocketConfig, EnableWebSocket, WebSocketConfigurer, WebSocketHandlerRegistry

### Community 372 - "UserRepositoryTest.java"
Cohesion: 0.53
Nodes (4): DataJpaTest, EntityManager, Test, UserRepositoryTest

### Community 373 - "Q: Implement approved plan for scoped students managing groups, assignments, grading, notifications, and admin role/scope lifecycle"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: Implement approved plan for scoped students managing groups, assignments, grading, notifications, and admin role/scope lifecycle, Source Nodes

### Community 374 - "GroupRelationship"
Cohesion: 0.40
Nodes (4): GroupRelationship, ACCESSIBLE, ENROLLED, OWNED

### Community 375 - "Q: I recommend to move the manage groups option in the header, as the student dashboard button is there"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: I recommend to move the manage groups option in the header, as the student dashboard button is there, Source Nodes

## Knowledge Gaps
- **543 isolated node(s):** `USER_CREATED`, `USER_PROFILE_UPDATED`, `USER_ROLE_CHANGED`, `USER_BLOCKED`, `USER_UNBLOCKED` (+538 more)
...
- `GroupService` (3× useful, score=2.416560406)
- `.students()` (2× useful, score=1.123930133)
- `.listStudents()` (2× useful, score=1.123930133)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `User` connect `Notification Preferences` to `Assignment Update Requests`, `Sign-Up Request DTO`, `Assignment Feedback & Student Work`, `LanguageExecutorFactoryTest`, `Frontend Assignment API Client`, `User DTO`, `CSV Bulk Register Response`, `PermissionMatrixIntegrationTest.java`, `Email Template Rendering`, `Async Config & Ownership Permission Tests`, `ExecutionTestCaseInfo`, `Admin User Controller`, `.submitCsvJob`, `StudentWorkQueryService`, `Notification Email Listener`, `Notification Dispatch Log`, `TestCaseInfo`, `@monaco-editor/react`, `Assignment Entity`, `Execution Entity`, `Create Assignment Request`, `Test Case Info (Queue)`, `Group Service`, `Group Controller`, `Group Controller Integration Tests`, `Submission Entity`, `TestSuiteRevision`, `AdminUserStatus`, `PasswordResetToken`, `JwtUtil`, `.error`, `AssignmentController.java`, `AssignmentFeedback`, `UserDTO`, `ExecutionTestCaseInfo`, `GroupMetricsControllerIntegrationTest.java`, `.buildExecutionJob`, `NotificationDispatchLog`, `GroupDTO`, `DisplayName`, `GroupServiceTest`, `StudentAssignmentWorkDTO`, `AuthController.java`, `GroupServiceTest`, `CheckExecutionControllerIntegrationTest.java`, `CreateAssignmentPage.tsx`, `DisplayName`, `NotificationReminderScheduler`, `.fixture`, `.toDTO`, `StudentWorkQueryService`, `AdminInitializer.java`, `UpdatePasswordRequest`, `TestCaseInfo`, `SubmissionController.java`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `AdminInitializer.java` to `Assignment Feedback & Student Work`, `NotificationReminderScheduler.java`, `LanguageExecutorFactoryTest`, `Frontend Assignment API Client`, `PermissionMatrixIntegrationTest.java`, `Notification Preferences`, `.submitCsvJob`, `StudentWorkQueryService`, `Notification Email Listener`, `Notification Dispatch Log`, `TestCaseInfo`, `Group Service`, `Group Controller`, `Group Controller Integration Tests`, `Submission Entity`, `AdminUserStatus`, `TestSuiteRevision`, `PasswordResetToken`, `JwtUtil`, `.error`, `UserDTO`, `ExecutionTestCaseInfo`, `.buildExecutionJob`, `NotificationDispatchLog`, `GroupDTO`, `DisplayName`, `zustand`, `GroupServiceTest`, `CheckExecutionControllerIntegrationTest.java`, `.fixture`, `StudentWorkQueryService`, `.fixture`, `RateLimitIncidentServiceTest.java`, `SubmissionController.java`, `UserRepositoryTest.java`, `UpdatePasswordRequest`, `TestCaseInfo`, `SubmissionController.java`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `LoginPage()` connect `ExecutionDTO` to `Submission Entity`?**
