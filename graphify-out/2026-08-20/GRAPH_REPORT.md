# Graph Report - CodeHive  (2026-08-20)

## Corpus Check
- 659 files · ~209,592 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5185 nodes · 13035 edges · 337 communities (244 shown, 93 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1457 edges (avg confidence: 0.8)
...
6. `EntityNotFoundException` - 83 edges
7. `Execution` - 81 edges
8. `Language` - 79 edges
9. `Submission` - 75 edges
...
## Communities (337 total, 93 thin omitted)

### Community 0 - "Assignment Update Requests"
Cohesion: 0.08
Nodes (9): fromValue(), TestSuiteUpdateMode, APPEND, REPLACE_ALL, UpdateAssignmentRequest, AssignmentUpdateServiceTest, Test, UpdateFixture (+1 more)
...
Cohesion: 0.28
Nodes (12): ApplicationEvents, CheckExecutionControllerIntegrationTest, ActiveProfiles, AutoConfigureMockMvc, BeforeEach, Import, MockMvc, ObjectMapper (+4 more)
...
Cohesion: 0.09
Nodes (24): listAssignments(), listAssignmentsForGroups(), getGroup(), leaveGroup(), listMyGroups(), listGroupSubmissions(), GroupCardProps, StudentBreadcrumb (+16 more)
...
Cohesion: 0.05
Nodes (20): EnrollmentStatusCount, Entity, Table, StudentAssignmentWork, StudentWorkStatus, NOT_SUBMITTED, RETURNED, SUBMITTED (+12 more)

### Community 17 - "Admin User Controller"
Cohesion: 0.08
Nodes (35): ApiError, ErrorResponse, jsonBody(), studentAuthHeaders(), studentRequest(), SuccessResponse, getExecution(), getExecutionReport() (+27 more)

### Community 18 - "Group Metrics Overview"
Cohesion: 0.08
Nodes (13): AssignmentPage(), LANGUAGE_FILE, LANGUAGE_LABELS, LANGUAGE_TEMPLATES, LANGUAGE_VERSIONS, LeftTab, MobilePane, MONACO_LANG_MAP (+5 more)
...
Cohesion: 0.08
Nodes (21): Component, Logger, LanguageExecutorFactory, LanguageExecutor, ExecutionReport, Logger, ObjectMapper, Service (+13 more)

### Community 21 - "Assignment Controller Integration Tests"
Cohesion: 0.14
Nodes (10): BulkGradeReturnDTO, AssignmentGradeService, Service, Transactional, AssignmentGradeServiceTest, Assignment, AssignmentGrade, BeforeEach (+2 more)

### Community 22 - "Assignment Service & Clone DTOs"
Cohesion: 0.23
Nodes (6): CsvBulkRegistrationTests, DisplayName, Test, User, RegistrationTests, MockMultipartFile
...
Cohesion: 0.03
Nodes (22): ClassGroup, Entity, Table, GroupEnrollment, Entity, Table, Entity, Override (+14 more)
...
Cohesion: 0.03
Nodes (16): JsonInclude, TestCaseInfo, TestGenerationJob, RecentSubmissionDTO, ComparatorType, EXACT_MATCH, FLOATING_POINT, Language (+8 more)

### Community 29 - "Assignment Entity"
Cohesion: 0.03
Nodes (16): AssignmentManagementStatusDTO, AssignmentMetricsDTO, Assignment, Entity, Table, AssignmentExample, Entity, Table (+8 more)
...
Cohesion: 0.17
Nodes (7): AccessDeniedException, EntityNotFoundException, GroupService, SecureRandom, Service, Transactional, Transactional
...
Cohesion: 0.22
Nodes (7): AssignmentServiceTest, Assignment, BeforeEach, ClassGroup, Test, User, EntityGraph
...
Cohesion: 0.22
Nodes (5): Scheduled, Transactional, ArtifactCleanupServiceTest, BeforeEach, Test

### Community 41 - "Group Controller Integration Tests"
Cohesion: 0.05
Nodes (34): AdminInitializer, Component, Logger, Override, PasswordEncoder, AdminUserControllerIntegrationTest, ActiveProfiles, AutoConfigureMockMvc (+26 more)
...
Cohesion: 0.11
Nodes (35): jsonRequest(), teacherAuthHeaders(), teacherRequest(), createGroup(), getAssignmentMetrics(), assignmentPath(), createFeedback(), deleteFeedback() (+27 more)

### Community 46 - "Scope.java"
Cohesion: 0.14
Nodes (13): deleteAssignment(), getAssignmentManagementStatus(), getTeacherDashboard(), listTeacherGroups(), ConfirmDialog(), StatusPill(), TeacherError(), TeacherLoading() (+5 more)

### Community 47 - "TestSuiteRevision"
Cohesion: 0.25
Nodes (3): Transactional, Test, StudentSubmissionQueryServiceTest
...
Cohesion: 0.20
Nodes (9): Entity, Table, PasswordResetToken, PasswordResetTokenRepository, BeforeEach, ExtendWith, PasswordEncoder, RecoveryPasswordServiceTest (+1 more)
...
Cohesion: 0.06
Nodes (44): getAssignment(), listMyAssignmentFeedback(), listMyAssignmentOverviews(), listAssignmentSubmissions(), listRecentSubmissions(), withdrawSubmission(), ExecutionReportPage(), GradeFilter (+36 more)
...
Cohesion: 0.11
Nodes (29): cloneAssignment(), createAssignment(), getActiveTeacherGroups(), getAssignmentUpdate(), getCloneAssignmentForm(), multipartMetadata(), multipartRequest(), updateAssignment() (+21 more)
...
Cohesion: 0.07
Nodes (14): Entity, Table, UserNotificationSettings, UpdateNotificationPreferenceRequest, UpdateNotificationSettingsRequest, UserNotificationSettingsRepository, Service, Transactional (+6 more)
...
Cohesion: 0.09
Nodes (13): byteSize(), CreateAssignmentPage(), EXT_TO_LANG, LANGUAGE_TEMPLATES, LANGUAGES, lineCount(), PublishMode, SolutionMode (+5 more)

### Community 59 - "AssignmentGradeHistory"
Cohesion: 0.05
Nodes (64): AssignmentStudentWorkController, Authentication, DeleteMapping, GetMapping, Operation, PostMapping, PreAuthorize, PutMapping (+56 more)
...
Cohesion: 0.10
Nodes (19): ApiResponses, Operation, PostMapping, RequestMapping, ResponseEntity, RestController, SecurityRequirements, SuccessResponse (+11 more)

### Community 62 - "ExecutionTestCaseInfo"
Cohesion: 0.09
Nodes (26): Component, Logger, TestGenerationResultListener, Component, NotificationFormatService, AssignmentNotificationStrategy, Component, AssignmentRepository (+18 more)
...
Cohesion: 0.09
Nodes (17): Logger, RabbitTemplate, Service, TestGenerationRequestProducer, AssignmentUpdateDTO, ValidationException, AssignmentLimits, ReferenceSolutionRevisionRepository (+9 more)
...
Cohesion: 0.05
Nodes (10): EnrollmentDTO, EnrollmentStudentDTO, GroupDTO, JsonInclude, EnrollmentStatus, ACTIVE, LEFT, REMOVED (+2 more)
...
Cohesion: 0.04
Nodes (30): AssignmentController, ApiResponses, Authentication, DeleteMapping, GetMapping, Logger, MultipartFile, Operation (+22 more)
...
Cohesion: 0.22
Nodes (8): AuthServiceTest, BeforeEach, ExtendWith, LoginRequest, Nested, PasswordEncoder, SignUpRequest, LoginTests
...
### Community 78 - ".create"
Cohesion: 0.06
Nodes (16): Entity, Table, Submission, Query, Query, SubmissionRepository, Service, StudentSubmissionQueryService (+8 more)
...
Cohesion: 0.07
Nodes (19): Scope, CHECK_ANALYTICS, CREATE_ADMINS, CREATE_GROUP, CREATE_USERS, MANAGE_ADMIN_STATUS, MANAGE_GROUPS, MANAGE_SCOPES (+11 more)
...
Cohesion: 0.15
Nodes (16): AdminUserController, ApiResponses, Authentication, DeleteMapping, GetMapping, Operation, PatchMapping, PostMapping (+8 more)
...
Cohesion: 0.16
Nodes (12): MinioClient, Service, ObjectStorageService, ActiveProfiles, Assignment, AutoConfigureMockMvc, Import, MockMvc (+4 more)
...
Cohesion: 0.08
Nodes (30): STUDENT_NAV, STUDENT_SIDEBAR_ITEMS, STUDENT_STATS_ICONS, getTeacherAssignment(), getTeacherAssignmentPreview(), normalizeAssignment(), restoreAssignment(), TeacherNavigation (+22 more)
...
### Community 103 - "clsx"
Cohesion: 0.13
Nodes (30): getTeacherAssignmentPage(), getTeacherAssignments(), archiveGroup(), deleteGroup(), getTeacherGroup(), groupPath(), listGroupStudents(), removeGroupStudent() (+22 more)
...
Cohesion: 0.09
Nodes (19): AcceptedPerformance, AssignmentMetricsDetailDTO, GradeSummary, StudentBreakdown, StudentRef, CurrentSubmissionRow, AssignmentBreakdown, EnrollmentBreakdown (+11 more)

### Community 107 - "MockMultipartFile"
Cohesion: 0.15
Nodes (23): getGroupMetricsOverview(), listAssignmentMetrics(), listStudentMetrics(), percentage(), TeacherAnalyticsPage(), AssignmentValidationStatus, Language, TeacherDashboardData (+15 more)
...
Cohesion: 0.15
Nodes (17): ExecutionRequestProducer, Logger, RabbitTemplate, Service, ApplicationEventPublisher, Component, NotificationDomainEventPublisher, Component (+9 more)
...
### Community 133 - "MockMultipartFile"
Cohesion: 0.39
...
Cohesion: 0.50
Nodes (3): BeforeEach, ClassGroup, User
...
Cohesion: 0.11
Nodes (15): GroupNotificationStrategy, Component, AssignmentGradeRepository, ClassGroupRepository, GroupEnrollmentRepository, StudentAssignmentWorkRepository, UserRepository, Service (+7 more)
...
### Community 248 - "framer-motion"
Cohesion: 0.26
Nodes (4): Component, DockerClient, Override, JavaExecutor

### Community 249 - "ComparatorType"
Cohesion: 0.43
Nodes (4): ExecutionResultListener, Component, Logger, RabbitListener
...
### Community 346 - "StudentWorkQueryService"
Cohesion: 0.14
...
## Knowledge Gaps
- **485 isolated node(s):** `METADATA`, `REFERENCE_ONLY`, `TEST_SUITE`, `VALIDATING`, `APPLIED` (+480 more)
...
- **Why does `User` connect `Notification Dispatch Log` to `Sign-Up Request DTO`, `Assignment Feedback & Student Work`, `Execution Job Queue Model`, `Frontend Assignment API Client`, `User Notification Settings`, `User DTO`, `Notification Preferences`, `Assignment Controller Integration Tests`, `Notification Email Listener`, `Assignment Update Entity`, `Assignment Entity`, `Execution Entity`, `Create Assignment Request`, `Group Service`, `Notification Format Service`, `Frontend Execution API Client`, `Group Controller`, `AssignmentValidationStatus`, `Group Controller Integration Tests`, `Execution Request Service`, `Submission Entity`, `TestSuiteRevision`, `useTheme`, `PasswordResetToken`, `JwtUtil`, `.error`, `AssignmentController.java`, `AssignmentGradeHistory`, `ExecutionTestCaseInfo`, `RecoveryPasswordRequest`, `GroupMetricsControllerIntegrationTest.java`, `.buildExecutionJob`, `AssignmentDTO`, `GroupDTO`, `useAuth`, `CheckExecutionControllerIntegrationTest.java`, `.create`, `DisplayName`, `GroupServiceTest`, `TeacherDashboardPage.tsx`, `AuthController.java`, `StudentWorkQueryService`, `DisplayName`, `AuthControllerIntegrationTest.java`, `UpdatePasswordRequest`, `TestCaseInfo`, `NotificationDomainEventRouter`?**
  _High betweenness centrality (0.155) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `AssignmentValidationStatus` to `Sign-Up Request DTO`, `Assignment Feedback & Student Work`, `Frontend Assignment API Client`, `Notification Preferences`, `Assignment Controller Integration Tests`, `Notification Email Listener`, `Notification Dispatch Log`, `Group Service`, `Notification Format Service`, `Frontend Execution API Client`, `Group Controller Integration Tests`, `useTheme`, `PasswordResetToken`, `JwtUtil`, `.error`, `AssignmentController.java`, `AssignmentGradeHistory`, `RecoveryPasswordController.java`, `ExecutionTestCaseInfo`, `GroupMetricsControllerIntegrationTest.java`, `AssignmentDTO`, `GroupDTO`, `useAuth`, `.create`, `GroupServiceTest`, `TeacherDashboardPage.tsx`, `StudentWorkQueryService`, `AdminUserControllerIntegrationTest`, `AuthControllerIntegrationTest.java`, `SubmissionController.java`, `UpdatePasswordRequest`, `TestCaseInfo`, `NotificationDomainEventRouter`?**
