...
## Corpus Check
- 667 files · ~219,419 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5306 nodes · 13314 edges · 339 communities (242 shown, 97 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1468 edges (avg confidence: 0.8)
...
## Communities (339 total, 97 thin omitted)

### Community 0 - "Assignment Update Requests"
Cohesion: 0.07
Nodes (10): fromValue(), TestSuiteUpdateMode, APPEND, REPLACE_ALL, UpdateAssignmentRequest, Query, AssignmentUpdate, Transactional (+2 more)
...
Cohesion: 0.05
Nodes (15): RabbitListener, Transactional, Entity, Table, TestCase, Entity, Table, TestSuiteRevision (+7 more)
...
Cohesion: 0.07
Nodes (15): Entity, Table, ReferenceSolutionRevision, MultipartFile, FileExtensionUtil, Assignment, BeforeEach, User (+7 more)

### Community 6 - "Frontend Assignment API Client"
Cohesion: 0.05
Nodes (43): CsvBulkRegisterResponse, JsonInclude, AssignmentControllerIntegrationTest, CreateAssignment, GetAssignmentById, ActiveProfiles, Assignment, AutoConfigureMockMvc (+35 more)
...
Cohesion: 0.08
Nodes (14): CExecutor, Component, DockerClient, Override, Component, DockerClient, Override, JavaExecutor (+6 more)
...
Cohesion: 0.16
Nodes (7): CurrentSubmissionRow, StudentWorkStatus, NOT_SUBMITTED, RETURNED, SUBMITTED, WITHDRAWN, Query

### Community 17 - "Admin User Controller"
Cohesion: 0.15
Nodes (7): Query, Assignment, BeforeEach, ClassGroup, User, Test, StudentSubmissionQueryServiceTest

### Community 18 - "Group Metrics Overview"
Cohesion: 0.05
Nodes (32): getAssignment(), getExecution(), listAssignmentSubmissions(), AssignmentPage(), LANGUAGE_FILE, LANGUAGE_LABELS, LANGUAGE_TEMPLATES, LANGUAGE_VERSIONS (+24 more)
...
Cohesion: 0.04
Nodes (23): AssignmentGrade, Entity, Table, Entity, Table, StudentAssignmentWork, AssignmentGradeService, Service (+15 more)
...
Cohesion: 0.03
Nodes (30): EnrollmentStatusCount, ClassGroup, Entity, Table, GroupEnrollment, Entity, Table, Entity (+22 more)
...
Cohesion: 0.04
Nodes (10): Assignment, Component, Logger, Scheduled, Transactional, NotificationReminderScheduler, Page, Pageable (+2 more)
...
Cohesion: 0.05
Nodes (11): ProtectedRoute(), ProtectedRouteProps, AuthContextType, CreateUserPage(), ROLE_OPTIONS, CsvUploadPage(), JoinGroupPage(), MyGroupsPage() (+3 more)
...
Cohesion: 0.05
Nodes (28): AccessDeniedException, AssignmentFeedbackDTO, AssignmentFeedback, Entity, Table, FeedbackStatus, DELETED, PUBLISHED (+20 more)

### Community 37 - "Frontend Execution API Client"
Cohesion: 0.14
Nodes (19): AnalyticsGroupContext(), AnalyticsHealth, AnalyticsOverview(), clamp(), formatDateTime(), formatPercentage(), KpiCard(), lifecycleTone() (+11 more)
...
Cohesion: 0.08
Nodes (37): listAssignments(), listAssignmentsForGroups(), jsonBody(), studentRequest(), submitExecution(), getGroup(), joinGroup(), leaveGroup() (+29 more)
...
Cohesion: 0.08
Nodes (9): AssignmentPreviewDTO, AssignmentPreviewTestCaseDTO, StudentSubmissionHistoryDTO, Language, C, CPP, JAVA, PYTHON (+1 more)
...
Cohesion: 0.07
Nodes (46): getExecutionReport(), jsonRequest(), teacherRequest(), createGroup(), getAssignmentMetrics(), listAssignmentMetrics(), assignmentPath(), createFeedback() (+38 more)
...
Cohesion: 0.06
Nodes (13): Entity, Table, Entity, Table, Submission, SubmissionRepository, Service, Transactional (+5 more)
...
Cohesion: 0.08
Nodes (10): MultipartFile, TestCaseInfo, TestCaseInfo, ExecutionJob, ExecutionTestCaseInfo, ExecutionJob, ExecutionTestCaseInfo, ObjectKeyBuilder (+2 more)
...
Cohesion: 0.08
Nodes (37): listMyAssignmentFeedback(), listMyAssignmentOverviews(), listRecentSubmissions(), GradeFilter, GradesPage(), AssignmentCard(), FilterTab, formatDate() (+29 more)
...
Cohesion: 0.05
Nodes (38): cloneAssignment(), createAssignment(), getActiveTeacherGroups(), getAssignmentUpdate(), getCloneAssignmentForm(), getTeacherAssignmentPreview(), multipartMetadata(), multipartRequest() (+30 more)
...
Cohesion: 0.08
Nodes (23): NotificationPreferenceDTO, NotificationType, ASSIGNMENT_CLOSE_SOON, ASSIGNMENT_CLOSE_SOON_NO_SUBMISSION, ASSIGNMENT_DUE_SOON, ASSIGNMENT_DUE_SOON_NO_SUBMISSION, ASSIGNMENT_GRADES_CLEARED, ASSIGNMENT_PUBLISHED (+15 more)

### Community 57 - "AssignmentFeedback"
Cohesion: 0.08
Nodes (14): Component, NotificationFormatService, AssignmentNotificationStrategy, Component, Override, GroupNotificationStrategy, Component, Override (+6 more)
...
Cohesion: 0.06
Nodes (57): AssignmentController, ApiResponses, Authentication, DeleteMapping, GetMapping, Logger, MultipartFile, Operation (+49 more)

### Community 60 - "auth.api.ts"
Cohesion: 0.11
Nodes (27): getAuthToken(), CsvProgressMessage, CsvTaskResponse, forgotPassword(), getMe(), login(), resetPassword(), signUp() (+19 more)
...
Cohesion: 0.04
Nodes (53): ApplicationEvents, Component, Logger, TestGenerationResultListener, ExecutionRequestProducer, Logger, RabbitTemplate, Service (+45 more)
...
Cohesion: 0.10
Nodes (20): Authentication, GetMapping, Operation, RequestMapping, ResponseEntity, RestController, SuccessResponse, Tag (+12 more)
...
Cohesion: 0.15
Nodes (10): AssignmentService, Logger, Service, Transactional, AssignmentServiceTest, Assignment, BeforeEach, ClassGroup (+2 more)
...
Cohesion: 0.09
Nodes (30): NotificationSettings, deleteAssignment(), getAssignmentManagementStatus(), getTeacherAssignment(), AssignmentContextBar(), assignmentGroupLifecycle(), AssignmentLifecycle, AssignmentList() (+22 more)
...
Cohesion: 0.12
Nodes (24): listTeacherGroups(), getGroupMetricsOverview(), formatDate(), GroupCardData, GroupCardSkeletons(), GroupsEmptyState(), GroupSort, GroupTab (+16 more)
...
Cohesion: 0.05
Nodes (23): AssignmentGradeHistoryDTO, AssignmentGradeHistory, Entity, Table, GradeChangeReason, CLEARED_MAX_POINTS_CHANGED, CLEARED_RESUBMISSION, CLEARED_TEST_SUITE_CHANGED (+15 more)

### Community 90 - "GroupMetricsController.java"
Cohesion: 0.07
Nodes (23): STUDENT_NAV, STUDENT_SIDEBAR_ITEMS, STUDENT_STATS_ICONS, TeacherNavigation, TeacherShell(), TEACHER_CREATE_NAV, TEACHER_CREATE_SIDEBAR_ITEMS, TEACHER_NAV (+15 more)
...
Cohesion: 0.15
Nodes (10): AcceptedPerformance, AssignmentMetricsDetailDTO, GradeSummary, StudentBreakdown, StudentRef, AssignmentMetricsDTO, AssignmentValidationStatus, FAILED (+2 more)
...
### Community 103 - "clsx"
Cohesion: 0.11
Nodes (33): getTeacherAssignmentPage(), getTeacherAssignments(), archiveGroup(), deleteGroup(), getTeacherGroup(), groupPath(), listGroupStudents(), removeGroupStudent() (+25 more)
...
Cohesion: 0.29
Nodes (3): GroupMetricsService, Service, Transactional

### Community 107 - "MockMultipartFile"
Cohesion: 0.07
Nodes (39): listStudentMetrics(), AssignmentAnalyticsDrawer(), AssignmentOverview(), AssignmentStudents(), DrawerTab, LANGUAGE_COLOR, workTone(), AnalyticsTab (+31 more)
...
Cohesion: 0.20
Nodes (4): SubmissionAttemptCount, SubmissionResultRow, GroupSnapshot, Test
...
Cohesion: 0.12
Nodes (22): AssignmentGradeRepository, AssignmentRepository, ExecutionRepository, GroupEnrollmentRepository, StudentAssignmentWorkRepository, UserRepository, ExecutionRequestService, ApplicationEventPublisher (+14 more)
...
## Knowledge Gaps
- **487 isolated node(s):** `METADATA`, `REFERENCE_ONLY`, `TEST_SUITE`, `VALIDATING`, `APPLIED` (+482 more)
...
- **Why does `User` connect `Notification Dispatch Log` to `Assignment Update Requests`, `Assignment Feedback & Student Work`, `LanguageExecutorFactoryTest`, `Frontend Assignment API Client`, `User DTO`, `Email Template Rendering`, `ExecutionTestCaseInfo`, `Admin User Controller`, `Assignment Controller Integration Tests`, `Notification Email Listener`, `Assignment Update Entity`, `Assignment Entity`, `Execution Entity`, `Create Assignment Request`, `Group Service`, `Notification Format Service`, `AssignmentValidationStatus`, `Group Controller Integration Tests`, `Submission Entity`, `TestSuiteRevision`, `useTheme`, `PasswordResetToken`, `JwtUtil`, `.error`, `AssignmentController.java`, `AssignmentFeedback`, `UserDTO`, `ExecutionTestCaseInfo`, `RecoveryPasswordRequest`, `GroupMetricsControllerIntegrationTest.java`, `.buildExecutionJob`, `NotificationDispatchLog`, `.update`, `CheckExecutionControllerIntegrationTest.java`, `DisplayName`, `GroupServiceTest`, `TeacherDashboardPage.tsx`, `AuthController.java`, `DisplayName`, `DisplayName`, `ExecutionTestCaseInfo`, `AuthControllerIntegrationTest.java`, `UpdatePasswordRequest`, `.fixture`, `NotificationDomainEventRouter`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `AssignmentValidationStatus` to `Assignment Feedback & Student Work`, `LanguageExecutorFactoryTest`, `Frontend Assignment API Client`, `Email Template Rendering`, `ExecutionTestCaseInfo`, `Assignment Controller Integration Tests`, `Notification Email Listener`, `Notification Dispatch Log`, `Group Service`, `Notification Format Service`, `Group Controller Integration Tests`, `TestSuiteRevision`, `useTheme`, `PasswordResetToken`, `JwtUtil`, `.error`, `AssignmentFeedback`, `ExecutionTestCaseInfo`, `.buildExecutionJob`, `.update`, `CheckExecutionControllerIntegrationTest.java`, `.create`, `AuthController.java`, `ExecutionTestCaseInfo`, `AdminUserControllerIntegrationTest`, `AuthControllerIntegrationTest.java`, `SubmissionController.java`, `AssignmentRepository`, `UpdatePasswordRequest`, `.fixture`, `NotificationDomainEventRouter`?**
