  ...
  if (mounted && !token) {
    return (
      <div className="min-h-screen flex overflow-hidden">
        ...
        <div className={`hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden bg-gradient-to-br from-imperial via-french to-azure animate-slide-in-left`}>
        ...
        <div className={`w-full lg:w-1/2 xl:w-2/5 flex flex-col bg-white dark:bg-dark-bg transition-colors duration-300 animate-slide-in-right`}>
