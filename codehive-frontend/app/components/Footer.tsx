      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-imperial via-french to-azure p-8 lg:p-16 text-center">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -top-24 -right-24 w-96 h-96 bg-yellow/20 rounded-full blur-3xl" />
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/signup" className="btn-secondary inline-flex items-center justify-center gap-2 text-lg">
                Start Teaching Free
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            <a href="/" className="flex items-center gap-3 mb-6">
              <img src={logo} alt="CodeHive" className="h-10 w-10" />
              <span className="text-xl font-bold gradient-text">CodeHive</span>
            </a>
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-xs">
              The modern platform for teaching programming. Create, evaluate, and inspire the next generation of developers.
            </p>
            {/* Social links */}
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-gray-100 dark:bg-dark-card flex items-center justify-center 
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link.name}>
                    <a
                      href={link.href}
                      className="text-gray-600 dark:text-gray-400 hover:text-azure dark:hover:text-yellow transition-colors"
                    >
                      {link.name}
                    </a>
                  </li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-sm text-gray-500 dark:text-gray-400 hover:text-azure dark:hover:text-yellow transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="text-sm text-gray-500 dark:text-gray-400 hover:text-azure dark:hover:text-yellow transition-colors">
              Terms of Service
