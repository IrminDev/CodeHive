      ...
      <header className="bg-white dark:bg-dark-surface border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          <div className="flex items-center gap-4">
            <a
              href="/admin"
              className="text-gray-500 dark:text-gray-400 hover:text-azure dark:hover:text-yellow transition-colors"
            >
              <svg
                className="w-5 h-5"
                fill="none"
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">
            The CSV file should contain no header row. Each row must have 6
          ...
          <div className="bg-gray-50 dark:bg-dark-card rounded-xl p-4 font-mono text-sm text-gray-700 dark:text-gray-300 overflow-x-auto">
            <p className="text-gray-400 dark:text-gray-500 mb-1">
              # role, name, fatherLastName, motherLastName, enrollmentNumber,
              email
            </p>
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-3">
            Valid roles: STUDENT, TEACHER, ADMIN. Maximum 1500 records per
            upload.
          </p>
        </div>
              ...
              <div className="mt-4">
                ...
                <ul className="space-y-1 max-h-48 overflow-y-auto">
                  {errors.map((err, i) => (
                    <li
                      key={i}
                      className="text-sm text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/10 px-3 py-1.5 rounded-lg"
                    >
                      {err}
                    </li>
                  ))}
