      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            We're a passionate team of developers and educators dedicated to transforming how programming is taught and learned.
          </p>
        </div>
          ...
          {creators.map((creator, index) => (
            ...
            >
              ...
              <div className={`absolute top-0 left-0 right-0 h-1 rounded-t-3xl bg-gradient-to-r ${
                index === 0 ? "from-azure to-french" : 
                index === 1 ? "from-yellow to-gold" : 
              ...
              <div className="flex justify-center mb-6">
                <div className={`w-28 h-28 rounded-full flex items-center justify-center text-5xl
                              bg-gradient-to-br ${
                                index === 0 ? "from-azure/20 to-french/20 dark:from-azure/30 dark:to-french/30" : 
                                index === 1 ? "from-yellow/20 to-gold/20 dark:from-yellow/30 dark:to-gold/30" : 
              ...
              <div className="text-center">
                ...
                <p className={`text-sm font-medium mb-4 ${
                  index === 0 ? "text-azure dark:text-azure-light" : 
                  index === 1 ? "text-yellow dark:text-gold" : 
        ...
        <div className="mt-16 lg:mt-24 text-center">
          <blockquote className="text-xl lg:text-2xl text-gray-700 dark:text-gray-300 italic max-w-3xl mx-auto">
            "We believe that learning to code should be engaging, accessible, and fun. That's why we built CodeHive."
          </blockquote>
          <p className="mt-4 text-azure dark:text-yellow font-medium">— The CodeHive Team</p>
        </div>
      </div>
    </section>
  );
