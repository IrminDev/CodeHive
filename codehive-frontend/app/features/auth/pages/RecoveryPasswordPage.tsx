      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-24">
          ...
          <p className="text-lg text-white/80 max-w-md mb-12">
            No worries! It happens to the best of us. Enter your email or
            enrollment number and we'll send you instructions to reset your
            password.
          </p>
              ...
              <>
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Enter the email address or enrollment number associated with
                    your account
                  </p>
                </div>
